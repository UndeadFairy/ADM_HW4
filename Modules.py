...
# dijkstra, witch returns dictionary with all the distances
def dijkstra_b(graph, source):
    ...
    while Q:
        ...
        for n in graph.neighbors(u):
            # we need to specify, that we have weighted graph
